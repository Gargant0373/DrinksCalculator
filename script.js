const constants = {
    birra: { perPerson: 1.5, bottleSize: 12, pricePerLiter: 9.5 },
    wine: { perPerson: 0.4, bottleSize: 10, pricePerLiter: 13 },
    absolut: { perPerson: 0.3, bottleSize: 1, pricePerLiter: 70 },
    gin: { perPerson: 0.2, bottleSize: 1, pricePerLiter: 92 },
    zarea: { perPerson: 0.1, bottleSize: 0.7, pricePerLiter: 32 },
    rom: { perPerson: 0.03, bottleSize: 0.7, pricePerLiter: 132 },
